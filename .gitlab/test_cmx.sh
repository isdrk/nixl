...
./bin/nixlbench --backend=DOCA_MEMOS —doca_memos_device_name=/dev/ng1n1 --start_block_size=4194304 --max_block_size=8388608 \
    --use_hugepages --start_batch_size=128 --max_batch_size=128 --op_type=READ,WRITE \
